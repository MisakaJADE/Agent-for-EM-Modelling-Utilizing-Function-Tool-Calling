tools = [
    {
        "type": "function",
        "name": "array_mode_end",
        "description": "Call this function when the user wants to end or quit the array modelling mode, Exit takes precedence over Entry",
        "parameters": {
            "type": "object",
            "properties": {},
            "required": [],
    ...
    {
        "type": "function",
        "name": "store_parameter_array",
        "description": "Call this function under array mode. Define the parameters by the name and the value, and can also be used to change the value of an existing parameter.",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    {
        "type": "function",
        "name": "define_component_array",
        "description": "Call this function under array mode. Define a new component with its name.",
        "parameters": {
            "type": "object",
            "properties": {
    ...
    {
        "type": "function",
        "name": "define_brick_array",
        "description": "Call this function under array mode. Define a brick model or rectangular model with its name, which component it belongs to, material used, and its boundary values.",
        "parameters": {
            "type": "object",
            ...
            "required": ["brick_name", "component_name", "material", "x_min", "x_max", "y_min", "y_max", "z_min", "z_max", "x_size", "y_size", "period"],
            "additionalProperties": False
        },
        "strict": True
    },
    ...
    {
        "type": "function",
        "name": "define_cylinder_z_array",
        "description": "Call this function under array mode. Define a cylinder model, the top and bottom are parallel to the xoy plane and it is stretched along z direction, and the model is defined by its material, and the cylinder can be solid or hollowed, depending on the definition of the parameters.",
        "parameters": {
            "type": "object",
            ...
            "required": ["cylinder_name", "component_name", "material_name", "outer_radius", "inner_radius", "z_min", "z_max", "x_center", "y_center", "x_size", "y_size", "period"],
            "additionalProperties": False
        },
        "strict": True
    },
    ...
    {
        "type": "function",
        "name": "rotate_around_origin_array",
        "description": "Call this function under array mode. Rotate a model around an axis (x, y, or z).",
        "parameters": {
            "type": "object",
            ...
            "required": ["model_name", "component_name", "angle_x", "angle_y", "angle_z", "multipleobjects", "repetition", "x_size", "y_size", "period"],
            "additionalProperties": False
        },
        "strict": True
    },
    ...
    {
        "type": "function",
        "name": "boolean_add_array",
        "description": "Call this function under array mode. Add two models together, the first model the user mentioned is the model 1, and the component it belongs to is the component 1.",
        "parameters": {
            "type": "object",
    ...
    {
        "type": "function",
        "name": "rename_model_array",
        "description": "Call this function under array mode. Change the name of a model without changing the component name it belongs to or the component it belongs to",
        "parameters": {
            "type": "object",
    ...
    {
        "type": "function",
        "name": "define_line_xy_array",
        "description": "Call this function under array mode. Define a line in the xoy plane with the coordinate of the beginning point to the ending point, the line will be under the directory of the curve.",
        "parameters": {
            "type": "object",
            ...
            "required": ["line_name", "curve_name", "start_point_x", "end_point_x", "start_point_y", "end_point_y", "x_size", "y_size", "period"],
            "additionalProperties": False
        },
        "strict": True
    },
    ...
    {
        "type": "function",
        "name": "transform_curve_array",
        "description": "Call this function under array mode. Transform or movement operation of the curve (including line)",
        "parameters": {
            "type": "object",
    ...
    {
        "type": "function",
        "name": "pick_end_points_array",
        "description": "Call this function under array mode. Pick the two end points of a line under the directory of a curve",
        "parameters": {
            "type": "object",
            "properties": {"curve_name": {"type": "string",
    ...
    {
        "type": "function",
        "name": "define_lumped_element_RLC_wire_array",
        "description": "Call this function under array mode. Define a lumped element, the element is on a wire and is composed of (equivalent of) a series or parallel RLC circuit.",
        "parameters": {
            "type": "object",
            ...
            "required": ["lumped_element_name", "folder_name", "type", "R", "L", "C", "p1_x", "p1_y", "p1_z", "p2_x", "p2_y", "p2_z", "x_size", "y_size", "period"],
            "additionalProperties": False
        },
        "strict": True
    },
